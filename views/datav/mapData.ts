/*
 * @Author: 李九阳
 * @Date: 2021-12-10 13:19:29
 * @LastEditors: 李九阳
 * @LastEditTime: 2021-12-10 16:36:19
 */
...
const mapData = {
  ...
  features: [
    ...
    },
    {
        ...
        coordinates: [
          ...
          [
            [
              ...
              [127.33333333333333, 22.7],
              [127.42857142857143, 22.25],
              [127.23809523809524, 22.25],
              [127.14285714285714, 22.7],
            ],
          ],
          [
      ...
      properties: { cp: [126, 25], name: "南海诸岛", childNum: 12 },
    },
  ],
};

export const d3MapChart = () => {
  const containerWidth = 936;
  const data = mapData;
  const margin = {
    top: 80,
    right: 20,
  ...
  const min: any = d3.min([containerWidth, containerHeight]);
  const projection = d3
  ...
  const z: any = d3.scaleOrdinal(d3.schemeCategory10); // 通用线条的颜色

  const g = chart
    .append("g")
    .attr("transform", "translate(35, 120)") // 设最外包层在总图上的相对位置
